...
export const TALENT_BRANCHES = [
  {
    ...
    nodes: [
      { id: 'f1', label: 'Жёсткий тап',     cost: 1, max: 5, dmg: 0.05 },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 't2', label: 'Торговля',        cost: 1, max: 5, gold: 0.05, requires: 't1' },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 's2', label: 'Мастер',          cost: 1, max: 5, ore: 0.10, requires: 's1' },
...
export function talentBonuses(talents) {
  const acc = { dmg: 0, gold: 0, crit: 0, rage: 0, ore: 0, weapon: 0, offline: 0 }
